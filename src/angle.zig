...
test "toString" {
    ...
    // std.debug.print("deg_str: {s}\n", .{deg_str});
    // std.debug.print("rad_str: {s}\n", .{rad_str});
    // std.debug.print("hrs_str: {s}\n", .{hrs_str});
    // std.debug.print("hms_str: {s}\n", .{hms_str});
    // std.debug.print("dms_str: {s}\n", .{dms_str});
    // std.debug.print("tst_str: {s}\n", .{tst_str});
    // std.debug.print("one_str: {s}\n", .{one_str});
