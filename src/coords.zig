...
test "RaDec toHor" {
    ...
    const lct: AstroDate = .{ .year = 1998, .month = 8, .day = 10, .hour = 23, .min = 10, .sec = 0, .tz = ad.tzBRT };
    const lst = ad.lctToLST(lct, city.lon);
